...
class TranscriptionAgent:
    ...
    def start(self):
        ...
        try:
            ...
            self.silence_check_thread = threading.Thread(
                target=self._check_silence_loop, 
                daemon=True
            )
    ...
    def update_gui_state(self):
        ...
        self.gui.update_state(
            ...
            has_transcript_file=(self.current_transcript_file is not None and 
                               os.path.exists(self.current_transcript_file))
        )
    ...
    def _transcription_worker(self):
        ...
        try:
            ...
            while (self.deepgram_client.is_connected() and 
